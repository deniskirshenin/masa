...
var _initBurger = require("./modules/burger/init-burger");
var _initSubMenu = require("./modules/sub-menu/init-sub-menu");
var _initSwiper = require("./modules/swiper/init-swiper");
require("./modules/select");
var _initFilter = require("./modules/filter/init-filter");
var _initMap = require("./modules/map/init-map");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initBurger.initBurger)();
    (0, _initSubMenu.initSubMenu)();
    (0, _initSwiper.initHeroSwiper)();
    (0, _initSwiper.initProgramSwiper)();
    (0, _initSwiper.initNewsSwiper)();
    (0, _initFilter.initFilter)();
    (0, _initSwiper.initReviewSwiper)();
    (0, _initMap.initMap)();
  });
});
...
},{"./modules/accordion/init-accordion":4,"./modules/burger/init-burger":7,"./modules/filter/init-filter":9,"./modules/form-validate/form":11,"./modules/map/init-map":17,"./modules/modals/init-modals":18,"./modules/select":20,"./modules/sub-menu/init-sub-menu":24,"./modules/swiper/init-swiper":25,"./utils/ios-vh-fix":28}],3:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":6,"./scroll-lock":8}],6:[function(require,module,exports){
"use strict";
...
exports.initBurger = exports.burger = void 0;
var _burger = require("./burger");
var burger;
exports.burger = burger;
var initBurger = function initBurger() {
  exports.burger = burger = new _burger.Burger();
  burger.init();
};
exports.initBurger = initBurger;

},{"./burger":5}],8:[function(require,module,exports){
"use strict";
...
var _iosChecker = require("../../../header/js/ios-checker");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
},{"../../../header/js/ios-checker":1}],9:[function(require,module,exports){
"use strict";
...
var allTab = document.querySelector('.news__tabs-button--all');
var volunteerTab = document.querySelector('.news__tabs-button--volunteer');
var trainingTab = document.querySelector('.news__tabs-button--training');
var careerTab = document.querySelector('.news__tabs-button--career');
var travellingTab = document.querySelector('.news__tabs-button--travelling');
var newsCards = document.querySelectorAll('.news-card');
var newsCardsArray = Array.from(newsCards);
var initFilter = function initFilter() {
  allTab.addEventListener('click', function () {
    newsCardsArray.forEach(function (newsCard) {
      newsCard.classList.remove('news-card--remove');
      newsCard.classList.add('news-card--show');
    });
  });
  volunteerTab.addEventListener('click', function () {
    newsCardsArray.forEach(function (newsCard) {
      newsCard.classList.remove('news-card--remove');
  ...
  travellingTab.addEventListener('click', function () {
    newsCardsArray.forEach(function (newsCard) {
      newsCard.classList.remove('news-card--remove');
...
var staticImageMap = document.querySelector('.map__static');
var interactiveMap = document.querySelector('.map__interactive');
staticImageMap.classList.remove('map__static--nojs');
interactiveMap.classList.add('map__interactive--active');
var initMap = function initMap() {
  var map = L.map('map', {
    scrollWheelZoom: false
  }).setView([55.82463539574, 37.62663090998426], 13);
  var pinIcon = L.icon({
  ...
  var marker = L.marker([55.81662479208488, 37.636934254874106], {
    icon: pinIcon
  }).addTo(map);
};
...
},{"../../utils/focus-lock":26,"../../utils/scroll-lock":29}],20:[function(require,module,exports){
"use strict";

var _customSelect = require("./select/custom-select");
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
...
},{"./select/custom-select":22}],21:[function(require,module,exports){
"use strict";
...
exports.initSubMenu = void 0;
var links = document.querySelectorAll('.header__link--has-children');
var initSubMenu = function initSubMenu() {
  links.forEach(function (link) {
    link.addEventListener('click', function () {
      var sublistId = link.getAttribute('data-sublist');
...
exports.initReviewSwiper = exports.initProgramSwiper = exports.initNewsSwiper = exports.initHeroSwiper = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var hero = document.querySelector('.hero__wrapper');
var heroPagination = document.querySelector('.hero__pagination');
var heroSwiper;
var program = document.querySelector('.programs__slider-wrapper');
var programNextButton = document.querySelector('.programs__button-next');
var programPrevButton = document.querySelector('.programs__button-prev');
var programScrollbar = document.querySelector('.programs__scrollbar');
var news = document.querySelector('.news__slider-wrapper');
var newsNextButton = document.querySelector('.news__button-next');
var newsPrevButton = document.querySelector('.news__button-prev');
var newsPagination = document.querySelector('.news__pagination');
var review = document.querySelector('.reviews__slider-wrapper');
var reviewNextButton = document.querySelector('.reviews__button-next');
var reviewPrevButton = document.querySelector('.reviews__button-prev');
var reviewScrollbar = document.querySelector('.reviews__scrollbar');
var setContentHeightAndPosition = function setContentHeightAndPosition(swiper) {
  var activeSlide = swiper.slides[swiper.activeIndex];
  var headerHeight = activeSlide.querySelector('h2').offsetHeight;
  var textHeight = activeSlide.querySelector('p').offsetHeight;
  var buttonHeight = activeSlide.querySelector('.hero__btn-wrapper').offsetHeight;
  var contentHeight;
...
var initHeroSwiper = function initHeroSwiper() {
  heroSwiper = new _swiper.default(hero, {
    loop: true,
    slidesPerView: 1,
    speed: 300,
    pagination: {
...
var initProgramSwiper = function initProgramSwiper() {
  return new _swiper.default(program, {
...
exports.initProgramSwiper = initProgramSwiper;
var initNewsSwiper = function initNewsSwiper() {
  return new _swiper.default(news, {
    direction: 'horizontal',
    breakpoints: {
      1200: {
        slidesPerView: 3,
...
var initReviewSwiper = function initReviewSwiper() {
  return new _swiper.default(review, {
    direction: 'horizontal',
    breakpoints: {
      1200: {
        slidesPerView: 3,
...
exports.initReviewSwiper = initReviewSwiper;

},{"../../vendor/swiper":30}],26:[function(require,module,exports){
...
},{"./ios-checker":27}],30:[function(require,module,exports){
