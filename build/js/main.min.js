...
},{"./modules/accordion/init-accordion":3,"./modules/burger/init-burger":6,"./modules/form-validate/form":11,"./modules/map/init-map":17,"./modules/modals/init-modals":18,"./modules/select":20,"./modules/sub-menu/init-sub-menu":24,"./modules/swiper/init-swiper":25,"./utils/ios-vh-fix":28}],2:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":5,"./scroll-lock":8}],5:[function(require,module,exports){
"use strict";
...
},{"./burger":4}],7:[function(require,module,exports){
"use strict";
...
var initMap = function initMap() {
  ...
  }).setView([55.028728583914365, 82.92811675804462], 15);
  var pinIconLarge = L.icon({
    iconUrl: './img/pin-desktop.webp',
    iconSize: [50, 70]
  });
  var pinIconMedium = L.icon({
    iconUrl: './img/pin-tablet.webp',
    iconSize: [30, 40]
  });
  var pinIconSmall = L.icon({
  ...
  var marker = L.marker([55.028728583914365, 82.92811675804462], {
    icon: pinIconLarge
  }).addTo(map);
...
},{"./ios-checker":27,"dup":8}],30:[function(require,module,exports){
