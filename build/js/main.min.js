...
},{"./modules/accordion/init-accordion":4,"./modules/burger/init-burger":7,"./modules/form-validate/form":11,"./modules/map/init-map":17,"./modules/modals/init-modals":18,"./modules/select":20,"./modules/sub-menu/init-sub-menu":24,"./modules/swiper/init-swiper":25,"./utils/ios-vh-fix":28}],3:[function(require,module,exports){
"use strict";
...
var initFilter = function initFilter(slidesContainer, slides, swiper, tabButtons) {
  if (slidesContainer && slides && swiper && tabButtons) {
    tabButtons.forEach(function (tabButton) {
      tabButton.addEventListener('click', function () {
        var filter = tabButton.getAttribute('data-filter');
...
var _initFilter = require("../filter/init-filter");
...
var slides = document.querySelectorAll('.news-card');
var tabButtons = document.querySelectorAll('.news__tabs-button');
var newsSwiper;
...
var setContentHeightAndPosition = function setContentHeightAndPosition(swiper) {
  ...
  if (activeSlide) {
    var headerElement = activeSlide.querySelector('h2');
    var textElement = activeSlide.querySelector('p');
    var buttonElement = activeSlide.querySelector('.hero__btn-wrapper');
    if (headerElement && textElement && buttonElement && heroPagination) {
      var textHeight = textElement.offsetHeight;
      var buttonHeight = buttonElement.offsetHeight;
      var contentHeight;
...
var initNewsSwiper = function initNewsSwiper() {
  newsSwiper = new _swiper.default(news, {
    direction: 'horizontal',
    breakpoints: {
      1200: {
        slidesPerView: 3,
  ...
  if (news && slides && newsSwiper && tabButtons) {
    var newsSlidesContainer = news.querySelector('.swiper-wrapper');
    (0, _initFilter.initFilter)(newsSlidesContainer, slides, newsSwiper, tabButtons);
  }
};
...
},{"../../vendor/swiper":30,"../filter/init-filter":9}],26:[function(require,module,exports){
